...
namespace SettingsLib
{
	namespace ErrorCodes
	{
		...
		{
			CONFIG_INI_STATUS_SUCCESSFUL_OPERATION,
			CONFIG_INI_STATUS_ERROR_SET_WIDE_STRING_DATA,					// Error when apply a wide string in a ConfigIni class that is not configurated to wstring.
