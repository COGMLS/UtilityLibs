...
//
	...
	// Enable Token Debugger components
	#define VERSION_LIB_ENABLE_EXPERIMENTAL_TOKEN_DEBUGGER
	...
	#if defined(VERSION_LIB_ENABLE_EXPERIMENTAL_TOKEN_DEBUGGER) && (!defined(VERSION_LIB_ENABLE_EXPERIMENTAL_MAPPER) || !defined(VERSION_LIB_ENABLE_EXPERIMENTAL_VERSION_TOKEN_SYSTEM) || !defined(VERSION_LIB_ENABLE_EXPERIMENTAL_DICTIONARY))
		#error Token Debugger components need Token System, Token Mapper and Dictionary components to work
	#endif
